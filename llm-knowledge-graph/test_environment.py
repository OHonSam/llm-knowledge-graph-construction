...
class TestEnvironment(unittest.TestCase):
    ...
    def test_gemini_variables(self):
        if TestEnvironment.skip_env_variable_tests:
            self.skipTest("Skipping Gemini env variable test")

        self.env_variable_exists('GEMINI_API_KEY')
...
def suite():
    ...
    suite.addTest(TestEnvironment('test_gemini_variables'))
    suite.addTest(TestEnvironment('test_neo4j_variables'))
    # suite.addTest(TestEnvironment('test_openai_connection'))
    # suite.addTest(TestEnvironment('test_gemini_connection'))
